...
public class ToDoAppUI extends JFrame {
    ...
    private JPanel createSidePanel() {
        ...
        gbc.gridy = 4; panel.add(completeBtn, gbc);
        gbc.gridy = 5; panel.add(deleteBtn, gbc);
        gbc.gridy = 6; panel.add(undoBtn, gbc);
        gbc.gridy = 7; panel.add(viewAllBtn, gbc);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ToDoAppUI());
    }
}